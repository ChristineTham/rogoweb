  ...
  while (ntimes--) {
    ...
    if (no_command) {
      ...
      if (isdigit(ch)) {
         ...
         */
        switch (ch) {
          case CTRL('B'): case CTRL('H'): case CTRL('J'): case CTRL('K'):
          case CTRL('L'): case CTRL('N'): case CTRL('U'): case CTRL('Y'):
          case '.': case 'a': case 'b': case 'h': case 'j': case 'k': case 'l':
          case 'm': case 'n': case 'q': case 'r': case 's': case 't': case 'u':
          case 'y': case 'z': case 'B': case 'C': case 'H': case 'I': case 'J':
          case 'K': case 'L': case 'N': case 'U':
          case 'Y':
#ifdef MASTER
...
over:
      ...
      switch (ch) {
        ...
        case CTRL('Y'): case CTRL('U'): case CTRL('B'):
        case CTRL('N'): {
        ...
        case 'o': option(); after = FALSE; break;
        ...
        case CTRL('P'): after = FALSE; msg(huh); break;
        case CTRL('R'):
          after = FALSE;
          clearok(curscr,TRUE);
          wrefresh(curscr);
        ...
        default:
          ...
          if (wizard) switch (ch) {
              ...
              case '$': msg("inpack = %d", inpack); break;
              case CTRL('G'): inventory(lvl_obj, 0); break;
              case CTRL('W'): whatis(FALSE, 0); break;
              case CTRL('D'): level++; new_level(); break;
              case CTRL('A'): level--; new_level(); break;
              case CTRL('F'): show_map(); break;
              case CTRL('T'): teleport(); break;
              case CTRL('E'): msg("food left: %d", food_left); break;
              case CTRL('C'): add_pass(); break;
